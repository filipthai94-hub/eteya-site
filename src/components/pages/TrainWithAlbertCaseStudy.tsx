...
export default function TrainWithAlbertCaseStudy() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      const counters = [
        { el: counter1Ref.current, target: 3, prefix: '', suffix: 'x', format: false },
        { el: counter2Ref.current, target: 45, prefix: '', suffix: '%', format: false },
        { el: counter3Ref.current, target: 8, prefix: '', suffix: '', format: false },
      ]
