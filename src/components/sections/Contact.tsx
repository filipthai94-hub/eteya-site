    ...
    <section id="contact" className="py-20 lg:py-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form action={action} className="max-w-2xl space-y-6">
          {/* Honeypot */}
          <input type="text" name="website" aria-hidden="true" className="sr-only" tabIndex={-1} autoComplete="off" />
          ...
          {state?.success && <p className="text-et-accent text-sm">{t('success')}</p>}
