  ...
  return (
    <>
      <style>{`
        ...
        .nav-btn { display:flex;align-items:center;gap:5px;padding:0 14px;height:80px;font-family:var(--font-body),"Geist",sans-serif;font-size:15px;font-weight:400;color:rgba(255,255,255,.65);background:none;border:none;cursor:pointer;white-space:nowrap;transition:color .2s;letter-spacing:-.01em; }
