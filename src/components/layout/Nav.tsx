...
export default function Nav() {
  ...
  const handleCopy = useCallback(() => {
    navigator.clipboard.writeText('kontakt@eteyaconsulting.se').then(() => {
      setCopied(true)
      setPopupOpen(false)
  ...
  const handleMail = useCallback(() => {
    window.location.href = 'mailto:kontakt@eteyaconsulting.se'
    setPopupOpen(false)
  }, [])
  ...
  const SOCIALS = [
    ...
    { label: 'Dribbble', href: 'https://dribbble.com', icon: 'M12 0C5.375 0 0 5.375 0 12s5.375 12 12 12 12-5.375 12-12S18.625 0 12 0zm7.938 5.563a10.174 10.174 0 012.25 6.375c-.328-.063-3.625-.734-6.938-.313-.063-.156-.141-.328-.219-.5-.219-.484-.453-.969-.703-1.438 3.672-1.5 5.328-3.641 5.609-4.125zM12 1.828c2.578 0 4.938.984 6.703 2.578-.234.438-1.734 2.438-5.25 3.781-1.641-3.016-3.469-5.484-3.75-5.859A10.24 10.24 0 0112 1.828zM7.781 3.125c.266.344 2.063 2.844 3.734 5.781-4.703 1.25-8.859 1.234-9.297 1.234a10.22 10.22 0 015.563-7.016zM1.813 12.016v-.313c.422.016 5.25.063 10.25-1.438.281.563.563 1.125.813 1.703-.125.031-.266.078-.391.109C7.188 14.016 4.5 18.5 4.25 18.906a10.18 10.18 0 01-2.438-6.891zM12 22.203c-2.313 0-4.438-.797-6.125-2.125.188-.391 2.25-4.281 8.125-6.25h.063c1.453 3.781 2.063 6.953 2.219 7.891a10.12 10.12 0 01-4.281.484zm6.063-1.859c-.109-.656-.672-3.688-2.031-7.406 3.094-.5 5.813.313 6.156.422a10.19 10.19 0 01-4.125 6.984z' },
  ...
  return (
    <>
      <style>{`
        ...
        .en-social-icon{width:24px;height:24px;display:flex;align-items:center;justify-content:center;color:rgb(222,222,222);transition:color .3s cubic-bezier(.25,1,.5,1);text-decoration:none}
        .en-social-icon:hover{color:#fff}
        .en-social-icon svg{width:18px;height:18px;fill:currentColor}
              ...
              <div className="en-menu-talk-content">
                ...
                >
                  ...
                  <div className="en-menu-talk-text-icon">
                    <span className="en-menu-talk-email">kontakt@eteyaconsulting.se</span>
            ...
            <div className="en-footer-links">
              <div className="en-footer-link-wrap">
                <div className="en-footer-text-flip">
                  ...
                  <a href="#" className="en-hover">Integritetspolicy</a>
                </div>
              ...
              <div className="en-footer-link-wrap">
                <div className="en-footer-text-flip">
                  <a href="#">Villkor</a>
                  <a href="#" className="en-hover">Villkor</a>
                </div>
                <div className="en-footer-arrow">
                  <svg viewBox="0 0 14 14"><path d="M3.5 10.5L10.5 3.5M10.5 3.5H5M10.5 3.5V9" /></svg>
                </div>
