...
<FAQ items={[
  ...
  },
  {
    ...
    answer: "Den eskalerar till en människa enligt regler vi sätter upp innan go-live. En riktig AI-agent erkänner när den är osäker och kopplar över istället för att hitta på svar. Typiska eskaleringsregler: kunden ber explicit om människa, ärendet rör återbetalning över ett tröskelbelopp, eller agenten har låg confidence i klassificeringen av ärendet."
  },
  {
  ...
  },
  {
    ...
    answer: "Då förbättras din agent automatiskt. Vi byter underliggande modell (Claude, GPT, etc) utan att du behöver göra något. Det är vårt ansvar att hålla agenten uppdaterad. Du får bättre prestanda till samma eller lägre kostnad. Driftkostnaden per ärende har sjunkit cirka 80% mellan 2024 och 2026, och trenden fortsätter."
  }
]} />
