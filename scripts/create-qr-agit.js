...
async function createQRForAgit() {
  const qrData = await QRCode.create('https://www.eteya.ai/sv/om-oss/agit', {
  ...
  ctx.fillText('N° 002 — AUTH 14:32', 500, 160);

  ctx.font = 'bold 64px DejaVu';
  ctx.fillStyle = '#000000';
  ctx.fillText('AGIT AKALP', 500, 240);

  ctx.font = '14px DejaVuMono';
  ctx.fillStyle = 'rgba(0,0,0,0.5)';
  ctx.fillText('MEDGRUNDARE · ETEYA CONSULTING', 500, 290);
  ...
  // Favicon i mitten
  const faviconPath = '/home/openclaw/.openclaw/workspace/projects/eteya/site/public/favicon-192x192.png';
  ...
  ctx.fillText('WWW.ETEYA.AI/SV/OM-OSS/AGIT', 500, 1160);
  ...
  fs.writeFileSync('./public/qr-agit.png', buffer);
  console.log('QR-KOD FOR AGIT GENERERAD!');
}
...
createQRForAgit().catch(err => console.error('Fel:', err.message));
